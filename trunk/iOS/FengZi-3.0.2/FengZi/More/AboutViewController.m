        ...
        case 1:{
            switch (indexPath.row) {
                ...
                case 1:{
                    ...
                    [str addAttribute:ZForegroundColorAttributeName value:[UIColor colorWithRed:38.0/255.0 green:165.0/255.0 blue:245.0/255.0 alpha:1] range:NSMakeRange(0, Service_Email.length)];
                ...
                case 2:{
                    ...
                    [str addAttribute:ZForegroundColorAttributeName value:[UIColor colorWithRed:38.0/255.0 green:165.0/255.0 blue:245.0/255.0 alpha:1] range:NSMakeRange(0, Service_WebSite.length)];
                    label.zAttributedText = str;
                    [str release];
