...
- (void)showInfo{
    if (delegate != nil) {
        [delegate zxingControllerDidShowInfo:self];
    }
}
...
//    }
    ...
    if ([self soundToPlay] != nil) {
        _player=[[AVAudioPlayer alloc] initWithContentsOfURL:[self soundToPlay] error:nil];
...
- (void)decoder:(Decoder *)decoder didDecodeImage:(UIImage *)image usingSubset:(UIImage *)subset withResult:(TwoDDecoderResult *)twoDResult {
    ...
    gimage =[[UIImage imageWithCGImage:[self CGImageRotated90:image.CGImage]]retain];
