 ...
 * 
 */
public class ShareLogAction extends AppAction {

	private static final Log LOG = LogFactory.getLog("MyLog");
	private static final String appLog = "/apps/log/shareLog";
	...
	public String doService() {
		...
		try {
			...
			LOG.error("向服务器发送短信邮件分享信息常", e);
			result.set(baseError + 1, "向服务器发送短信邮件分享信息");
		}
