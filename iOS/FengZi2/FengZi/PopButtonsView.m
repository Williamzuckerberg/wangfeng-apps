...
-(void)initDataWithType:(LinkType)type withText:(NSString*)text{
    ...
    switch (type) {
        case LinkTypeCompany:
            width = 60;
            offsetx = 30;
            self.frame = CGRectMake(248, 4, width, 36);
        ...
        case LinkTypeEmail:
            ...
            self.frame = CGRectMake(248, 4, width, 36);
            _backImageView.frame = self.bounds;
            _backImageView.image = [UIImage imageNamed:@"pop_button2_bg.png"];
        ...
        case LinkTypeCardPhone:{
            width = 120;
            offsetx = 30;
            self.frame = CGRectMake(188, 4, width, 36);
            _backImageView.frame = self.bounds;
            _backImageView.image = [UIImage imageNamed:@"pop_button2_bg.png"];
        ...
        case LinkTypeText:
            ...
            _backImageView.image = [UIImage imageNamed:@"pop_button2_bg.png"];
            _smsBtn.center = CGPointMake(offsetx, 18);
            _emailBtn.center = CGPointMake(offsetx*3, 18);
            break;
        case LinkTypeUrl:
            width = 60;
            offsetx = 30;
