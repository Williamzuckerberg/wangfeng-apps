...
@interface iOSRefreshTableView : NSObject<iOSRefreshTableHeaderDelegate, UIScrollViewDelegate>
{
    BOOL                        _reloading;
    iOSRefreshTableHeaderView   *_headView;
    iOSRefreshTableHeaderView   *_footerView;
